...
tags = {
    "os_fiz": "http://crd.gov.pl/wzor/2020/05/08/9394/",
...
tags_v2 = {
    "os_fiz": "http://crd.gov.pl/wzor/2021/12/27/11148/",
...
tags_v2k = {
    "os_fiz": "http://crd.gov.pl/wzor/2021/12/27/11149/",
    "os_niefiz": "http://crd.gov.pl/wzor/2021/12/27/11149/",
    "etd": "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2021/06/08/eD/DefinicjeTypy/",
}
tags_v3m = {  # TODO: fill if needed
    "os_fiz": "http://crd.gov.pl/wzor/2025/12/19/14090/",
    "os_niefiz": "http://crd.gov.pl/wzor/2021/12/27/11148/",
    "etd": "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2021/06/08/eD/DefinicjeTypy/",
}
tags_v3k = {
    "os_fiz": "http://crd.gov.pl/wzor/2025/12/19/14089/",
    "os_niefiz": "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2022/09/13/eD/DefinicjeTypy/",
    "etd": "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2021/06/08/eD/DefinicjeTypy/",
}
...
class NamespaceHelper:
    ...
    def registerNamespaces(self):
        ...
        if self.year >= 2026:
            for key, value in tags_v3m.items():
                register_namespace(key, value)
            for key, value in tags_v3k.items():
                register_namespace(key, value)
        elif self.year >= 2022:
    ...
    def findAllTnsaElementsWithTag(self, tag: str, document: Element) -> Element:
        for option in [True, False]:
            tnsa_tag = self.getTnsaTag(tag, option)
            # print(f"Szukam taga {tnsa_tag}")
            list = document.findall(f".//{tnsa_tag}")
    ...
    def changeTagOsFizToEtd(self, tag: str):
        return replace({self.tags["os_fiz"]: self.tags["os_niefiz"]}, tag)
